...
Clone the git repositories for vuicoin and Gitian.
...
in the vuicoin repository under 'Fetch and create inputs' to install sources which require
...
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the vuicoin repository.
...
Output from `gbuild` will look something like
    ...
    From https://github.com/boxaltcoin/vuicoin
...
For example:
```bash
URL=https://github.com/thrasher-/vuicoin.git
...
[boxaltcoin/gitian.sigs.ltc](https://github.com/boxaltcoin/gitian.sigs.ltc/) repository, or if that's not possible create a pull
