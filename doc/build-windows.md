...
for Ubuntu Xenial does not produce working executables for some of the Vuicoin Core applications.
...
causes two of the vuicoin executables to crash shortly after start up. The bug is related to the
