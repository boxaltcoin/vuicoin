# PSBT Howto for Vuicoin Core

Since Vuicoin Core 0.17, an RPC interface exists for Partially Signed Vuicoin
...
PSBT is an interchange format for Vuicoin transactions that are not fully signed
...
#### Multisig with multiple Vuicoin Core instances

Alice, Bob, and Carol want to create a 2-of-3 multisig address. They're all using
Vuicoin Core. We assume their wallets only contain the multisig funds. In case
